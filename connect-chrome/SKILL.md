...
version: 0.1.0
description: |
  Launch real Chrome controlled by astack with the Side Panel extension auto-loaded.
...
Connect Claude to a visible Chrome window with the astack extension auto-loaded.
...
- The astack Chrome extension pre-loaded
- A green shimmer line + "astack" pill so you know which window is controlled
...
> Chrome is launched with astack control. You should see a green shimmer line at the
> top of the Chrome window and a small "astack" pill in the bottom-right corner.
>
> The Side Panel extension is pre-loaded. To open it:
> 1. Look for the **puzzle piece icon** (Extensions) in Chrome's toolbar
> 2. Click it → find **astack browse** → click the **pin icon** to pin it
> 3. Click the **astack icon** in the toolbar
...
> the astack icon and enter port {PORT} manually.
...
> 2. Look for "astack browse" — it should be listed and enabled
