# Design System — astack

## Product Context
- **What this is:** Community website for astack — a CLI tool that turns Claude Code into a virtual engineering team
- **Who it's for:** Developers discovering astack, existing community members
