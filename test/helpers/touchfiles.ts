...
export const E2E_TOUCHFILES: Record<string, string[]> = {
  ...
  // Ship
  'ship-base-branch': ['ship/**', 'bin/astack-repo-mode'],
  ...
  // Global discover
  'global-discover':   ['bin/astack-global-discover.ts', 'test/global-discover.test.ts'],
  ...
  'codex-review-findings': ['review/**', '.agents/skills/astack-review/**', 'codex/**', 'test/helpers/codex-session-runner.ts', 'lib/worktree.ts'],
  ...
  'gemini-review-findings': ['review/**', '.agents/skills/astack-review/**', 'test/helpers/gemini-session-runner.ts', 'lib/worktree.ts'],


  // Coverage audit (shared fixture) + triage + gates
  'ship-coverage-audit': ['ship/**', 'test/fixtures/coverage-audit-fixture.ts', 'bin/astack-repo-mode'],
  ...
  'ship-triage': ['ship/**', 'bin/astack-repo-mode'],
  ...
  'land-and-deploy-first-run':     ['land-and-deploy/**', 'scripts/gen-skill-docs.ts', 'bin/astack-slug'],
  'land-and-deploy-review-gate':   ['land-and-deploy/**', 'bin/astack-review-read'],
...
export const E2E_TIERS: Record<string, 'gate' | 'periodic'> = {
  ...
  // astack-upgrade
  'astack-upgrade-happy-path': 'gate',
