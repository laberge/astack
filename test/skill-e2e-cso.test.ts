...
- Save the report to .astack/security-reports/.`,
    ...
    const reportDir = path.join(csoDir, '.astack', 'security-reports');
...
- Skip the preamble (astack-update-check, telemetry, etc.) — go straight to the audit.
