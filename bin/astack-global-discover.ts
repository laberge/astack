#!/usr/bin/env bun
/**
 * astack-global-discover — Discover AI coding sessions across Claude Code, Codex CLI, and Gemini CLI.
 ...
 *
 * Usage:
 *   astack-global-discover --since 7d [--format json|summary]
 *   astack-global-discover --help
 */
...
function printUsage(): void {
  console.error(`Usage: astack-global-discover --since <window> [--format json|summary]
...
Examples:
  astack-global-discover --since 7d
  astack-global-discover --since 14d --format summary`);
}
